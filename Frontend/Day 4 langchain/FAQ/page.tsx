...
const AskQuestionPage = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const res = await fetch('http://localhost:8080/FAQ', {
        ...
        body: JSON.stringify({ query }), // Send the question in the request body
      });
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br  from-purple-500 via-pink-500 to-gray-900 text-white">
      <div className="bg-white text-black p-8 rounded-xl shadow-md max-w-lg w-full">
        <h1 className="text-2xl font-bold text-center mb-4">🤖 FAQ</h1>
        <div className="mb-4">
          <textarea
